package it.sapienza.netlab.airmon.advertiser;
...
public class AdvertiserService extends Service {
    ...
    public static final String ADVERTISING_FAILED =
            "com.drone.android.it.sapienza.netlab.airmon.advertising_failed";
        ...
        if (mBluetoothLeAdvertiser == null) {
            ...
            if (mBluetoothManager != null) {
                ...
                if (mBluetoothAdapter != null) {
                    ...
                    Toast.makeText(this, "BluetoothObjectNull", Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(this, "BluetoothObjectNull", Toast.LENGTH_LONG).show();
            }
